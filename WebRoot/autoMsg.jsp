...
<body onload="loadForm('${autoMsg.responsetype}');">
    <div class="right">
      <div class="title">
        <div class="titlename">回复设置->自动回复</div>
      </div>
      <div class="keyframe">
        <div class="showframe">
          <div class="phone">
            ...
            <div id="firstmenu">
                    ...
                    <div class="firsttitle">
	                    回复类型：<select name=select id="select1">
	                    	<option id="option1" value="text" <c:if test="${autoMsg.responsetype!='news'}"> selected="selected"</c:if>>纯文本</option>
	                    	<option id="option2" value="news" <c:if test="${autoMsg.responsetype=='news'}"> selected="selected"</c:if>>单图文</option>
	                    </select>
                    </div>
                    ...
                    <form action = "addTextMessage" method="post">
			           ...
			           <input type="hidden" name="keyword" value="auto">
                    	<div class="firsttitle">消息标题：<input type="text"  name ="title" id="titletxt1" value="${autoMsg.title}"/></div>
                    	<div style="width:250px;height:auto;margin:5px auto"><textarea id="replytxt" name ="content" style="width:230px;border:1px solid #f0f0f0;min-height:80px">${autoMsg.content}</textarea></div>
                    ...
                    <div class="selectframe" id="div2">
                    	<form method="post" enctype="multipart/form-data" action = "addNewsMessage" >
						  	<input type="hidden" name="requestType" value="auto">
				           	<input type="hidden" name="keyword" value="auto">
				           	<div class="firsttitle">消息标题：<input type="text"  name ="title" id="titletxt2" value="${autoMsg.title}"  ></input></div>
                    	<div style="width:260px;height:auto;margin:0 auto">
                    	<div id="preview">
    						<img id="imghead" name ="picUrl" border=0 src='${autoMsg.picture}'>
						</div>
						<input type="file" name="uploadImage" onchange="previewImage(this)" /> 
                    	</div>
                    	<div style="width:250px;height:auto;margin:5px auto" value="图文描述">
                    	<textarea id="replytxt1" name ="content" style="width:230px;border:1px solid #f0f0f0;min-height:80px">${autoMsg.content}</textarea></div>
                    	<div class="firsttitle">图文链接：<input type="text" value="${autoMsg.linkurl}" name ="linkUrl" id="urltxt" /></div>
